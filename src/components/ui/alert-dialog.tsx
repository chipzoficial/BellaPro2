...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn("fixed left-1/2 top-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-border bg-background p-6 shadow-soft", className)}
      {...props}
    />
  </AlertDialogPortal>
));
...
export const AlertDialogFooter = (props: React.HTMLAttributes<HTMLDivElement>) => <div className="mt-6 flex justify-end gap-2" {...props} />;
